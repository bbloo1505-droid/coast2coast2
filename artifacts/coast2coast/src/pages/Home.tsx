  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground flex flex-col font-sans">
      ...
      >
        ...
        {/* Mobile Nav Dropdown */}
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-card border-b border-border shadow-xl py-4 px-6 flex flex-col gap-4 animate-in slide-in-from-top-2">
      ...
      <main className="flex-grow">
        ...
        <section id="hero" className="relative min-h-[100dvh] flex items-center pt-20">
          <div className="absolute inset-0 z-0">
            ...
            <img src={heroBg} alt="Mobile Mechanic Workshop" className="w-full h-full object-cover object-center" />
          </div>

          <div className="container relative z-20 mx-auto px-4 md:px-6">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/20 border border-primary/30 text-primary mb-6">
                <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                <span className="text-sm font-semibold tracking-widest uppercase">7 Days A Week • Sunshine Coast</span>
              </div>
              
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-display leading-[0.9] text-white mb-6 uppercase">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="tel:0435835688" className="inline-flex items-center justify-center gap-2 h-14 px-8 bg-primary text-primary-foreground font-display text-xl tracking-wider uppercase hover:bg-primary/90 transition-colors">
                  <Phone size={20} />
                  Call Mitch Now
                </a>
                <Button onClick={() => scrollTo("contact")} variant="outline" className="h-14 px-8 border-2 border-white/20 text-white font-display text-xl tracking-wider uppercase hover:bg-white hover:text-black transition-colors rounded-none">
                  Get A Quote
                </Button>
              </div>
              ...
              <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 border-t border-white/10 pt-8">
                <div className="flex flex-col gap-1">
                  <span className="font-display text-3xl text-primary">24/7</span>
                  <span className="text-xs text-muted-foreground uppercase tracking-widest">Always Open</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="font-display text-3xl text-primary">100%</span>
                  <span className="text-xs text-muted-foreground uppercase tracking-widest">Mobile Service</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="font-display text-3xl text-primary">RWC</span>
                  <span className="text-xs text-muted-foreground uppercase tracking-widest">Licensed Checks</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="font-display text-3xl text-primary">LR</span>
                  <span className="text-xs text-muted-foreground uppercase tracking-widest">Land Rover Spec</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Tagline Bar */}
        <div className="bg-primary py-8 overflow-hidden flex items-center justify-center border-y border-primary-border">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-5xl font-display tracking-[0.2em] text-white uppercase m-0">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-card border border-border p-8 hover:border-primary/50 transition-colors group relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -right-8 w-2/3 aspect-square z-20 border-8 border-[#0a0a0a]">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {REVIEWS.map((review, i) => (
                <div key={i} className="bg-[#151515] p-8 border border-white/5 flex flex-col justify-between">
                  <div className="mb-6">
      ...
      {/* Mobile Sticky CTA */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 p-4 bg-background/90 backdrop-blur-md border-t border-border z-50 flex gap-4">
        <a href="tel:0435835688" className="flex-1 flex items-center justify-center gap-2 h-14 bg-primary text-primary-foreground font-display text-lg tracking-wider uppercase">
          <Phone size={18} />
          Call Now
        </a>
      </div>
